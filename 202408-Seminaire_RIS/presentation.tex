...
\centering
\onslide<2->{\scalebox{0.8}{\begin{tikzpicture}
...
\pause
Collection des Dialogues\footnote<.(1)->{Minecraft Dialogue Corpus \tikz \node[baseline={(github.base)},outer sep=0pt,inner sep=0pt] (github) {\includegraphics[width=1em]{GitHub-Mark-32px.png}};} \pause\textrightarrow{} Génération d'énontiations\pause\ (Architect est un robot)
...
\begin{frame}{Travail}
  ...
  \vfill
  % \tableofcontents
  \onslide<2->{\tableofcontents[subsectionstyle=hide/hide/hide]}
