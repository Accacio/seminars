...
\pause
Collection des Dialogues\footnote<.(1)->{Minecraft Dialogue Corpus \raisebox{-.5ex}{\includegraphics[width=1em]{GitHub-Mark-32px.png}}} \pause\textrightarrow{} Génération d'énontiations\pause\ (Architect est un robot)
...
\begin{tikzpicture}[node distance={.1cm and 1cm}]
  ...
  \onslide<2->{\node[below=of architect_text] (minecraft_text) {\Large Malmö\footnote<2->{\raisebox{-.5ex}{\includegraphics[width=1em]{microsoft.png}} Malmö 2017  (API pour l'apprentissage par renforcement) \raisebox{-.5ex}{\includegraphics[width=1em]{GitHub-Mark-32px.png}}}};}
...
\begin{frame}{Tâches}
  ...
  \begin{description}[<+(1)->]
    ...
    \item[Task] liste de tâches (\texttt{TURN(LEFT)}, \texttt{PUT(blue)}, \texttt{TURN(RIGHT)}) \only<.(3)->{\alert{\textleftarrow} \stepcounter{beamerpauses}}
