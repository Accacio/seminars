...
\begin{frame}{About me}
  ...
  \begin{minipage}[c]{.7\linewidth}
    \begin{itemize}
      ...
      \item[] \textit{Garanteed relative localisation and anticollision scenario for autonomous vehicles}
...
\begin{frame}{Objective}{Study security in dMPC context}
  ...
  \begin{itemize}[<+(1)->]
    \item CentraleSupélec Rennes - Expertise in MPC for Smart Buildings
    \item Brittany Region (Sustainable Energy + cybersecurity)
  \end{itemize}
  \vspace{.05cm}
