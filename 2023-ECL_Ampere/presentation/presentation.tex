...
\begin{frame}{Distributed Model Predictive Control}
  ...
  Recent in dMPC literature\footnote<.(1)->{<30 documents in scopus} (First article from 2017\footnote<.(1)->{\cite{VelardeEtAl2017b}})\pause

  \vspace{.25cm}
  \begin{itemize}
    \item Incentive Brittany Region (Sustainable Energy + cybersecurity)\pause
    \item CentraleSupélec Rennes - MPC for Smart Buildings\pause
  \end{itemize}
