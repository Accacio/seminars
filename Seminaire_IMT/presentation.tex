% \documentclass[color,t,presentation,english]{beamer}
...
\usepackage{hhline}
\usepackage{tikz}
\usetikzlibrary{calc,arrows,shapes,decorations,intersections}
\usepackage{xifthen}
\usepackage{bbm}
...
%\subtitle{D'après le powerpoint}

\author{Équipe Commande - CODEx}
...
\frame{
    ...
    \note{Une note sur l'installation}
$ $\\
